...
mixin _$LoginResponseModel {
  ...
  UserShort get user => throw _privateConstructorUsedError;
...
abstract class $LoginResponseModelCopyWith<$Res> {
  ...
  $UserShortCopyWith<$Res> get user;
}
...
class _$LoginResponseModelCopyWithImpl<$Res, $Val extends LoginResponseModel>
  ...
  @pragma('vm:prefer-inline')
  $UserShortCopyWith<$Res> get user {
    return $UserShortCopyWith<$Res>(_value.user, (value) {
...
class _$LoginResponseModelImpl extends _LoginResponseModel {
  ...
  @override
  String toString() {
    return 'LoginResponseModel(id: $id, user: $user, accessToken: $accessToken, refreshToken: $refreshToken)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(id), user, accessToken, refreshToken);
...
abstract class _LoginResponseModel extends LoginResponseModel {
  const factory _LoginResponseModel(
      ...
      required final UserShort user,
      required final String accessToken,
      required final String refreshToken}) = _$LoginResponseModelImpl;
